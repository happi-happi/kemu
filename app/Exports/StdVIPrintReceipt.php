...
class StdVIPrintReceipt implements FromCollection, WithHeadings
{
    /**
    ...
    public function collection()
{
    ...
    $payments = stdvi_payment_fee::whereHas('user', function ($query) {
    ...
    // Convert the data array into a collection and return it
    return collect($data);
}
