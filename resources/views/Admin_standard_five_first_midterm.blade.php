...
<table class="table table-hover  table-bordered table-striped">
    <p>Standard five  firt midterm   table</p>
<thead >
  <tr>
      <th>Fname</th>
      <th>Mname</th>
...
<td><a href="{{ route('UpdateAdminStudentfivefirstMidtermresult', ['id' => $data ->id]) }}">Update</a></td>
</tr>   
...
<table class="table table-hover  table-bordered table-striped">
    <p>Standard five semi  annual   table</p>
<thead >
  <tr>
      <th>Fname</th>
      <th>Mname</th>
  ...
  <tbody>
@foreach ($standardfive_semi_annual as $standardfive_semi_annual )
<tr>
<td>{{$standardfive_semi_annual ->Fname}}</td>
<td>{{$standardfive_semi_annual ->Mname }}</td>
<td>{{$standardfive_semi_annual->Lname}}</td>
<td>{{$standardfive_semi_annual->Arabic}}</td>
<td>{{$standardfive_semi_annual->CivicsandMorals}}</td>
<td>{{$standardfive_semi_annual->English}}</td>
<td>{{$standardfive_semi_annual->EDK}}</td>
<td>{{$standardfive_semi_annual->Mathematics}}</td>
<td>{{$standardfive_semi_annual->Science}}</td>
<td>{{$standardfive_semi_annual ->Socialsstudies}}</td>
<td>{{$standardfive_semi_annual->Kiswahili}}</td>
<td><a href="{{ route('AdminStudentfivesemiannualresult', ['id' => $standardfive_semi_annual ->id]) }}">Update</a></td>
</tr>   
