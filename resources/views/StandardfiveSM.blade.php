...
<div class="dropdown">
  ...
  <ul class="dropdown-menu">
    ...
    <p>Standard Five second Midterm Data</p>
...
<table class="table   table-striped table-bordered">
    ...
    <tbody>
        <tr>
            <td>{{ $standardfiveSM->user->Fname }} {{ $standardfiveSM->user->Mname }} {{ $standardfiveSM->user->Lname }}</td>
            <td>{{ $standardfiveSM->Arabic }} {{ $STDVSMgrades['Arabic']}}{{ $positionArabicAL['Annual']['Arabic'] }}</td>
            <td>{{ $standardfiveSM->CivicsandMorals }} {{ $STDVSMgrades['CivicsandMorals']}}{{ $positionCivicsandMoralsAL['Annual']['CivicsandMorals'] }}</td>
            <td>{{ $standardfiveSM->English }} {{ $STDVSMgrades['English']}}{{ $positionEnglishAL['Annual']['English'] }}</td>
            <td>{{ $standardfiveSM->EDK }} {{ $STDVSMgrades['EDK']}}{{ $positionEDKAL['Annual']['EDK'] }}</td>
            <td>{{ $standardfiveSM->Mathematics }} {{ $STDVSMgrades['Mathematics']}}{{ $positionMathematicsAL['Annual']['Mathematics'] }}</td>
            <td>{{ $standardfiveSM->Science }} {{ $STDVSMgrades['Science']}}{{ $positionScienceAL['Annual']['Science'] }}</td>
            <td>{{ $standardfiveSM->Socialsstudies }} {{ $STDVSMgrades['Socialsstudies']}}{{ $positionScienceAL['Annual']['Socialsstudies'] }}</td>
            <td>{{ $standardfiveSM->Kiswahili }} {{ $STDVSMgrades['Kiswahili']}}{{ $positionKiswahiliAL['Annual']['Kiswahili'] }}</td>
            <td>{{$AverageAL}}</td>
        </tr>
    </tbody>
</table>
