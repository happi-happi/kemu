...
<div class="dropdown">
  ...
  <ul class="dropdown-menu">
    ...
    <li><a class="dropdown-item" href="{{route('StdVIIPaymentStatus')}}">Standard seven </a></li>
  </ul>
</div> 
...
<table>             
  <table class="table table-hover  table-bordered table-striped">
    ...
    <p>Standard Five Payment Status</p>
        <tr>
  ...
  <a class="btn btn-warning" href="{{ route('StdVPrintReceipt', ['id' => $user->user->id]) }}">
            Print Receipt
        </a>
</div></td>
   @endforeach
